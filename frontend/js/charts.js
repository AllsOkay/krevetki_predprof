...
function initCharts(analyticsData) {
    ...
    if (!analyticsData?.accuracy_vs_epochs?.accuracy?.length) {
        console.warn('Нет данных для accuracy_vs_epochs — график будет пустым');
    }
...
function initAccuracyChart(data) {
    ...
    if (!ctx) {
        console.warn('Canvas accuracyChart не найден');
        return;
    }
...
function initClassDistributionChart(data) {
    ...
    if (!ctx) {
        console.warn('Canvas classDistributionChart не найден');
        return;
    }
...
function initPerRecordChart(accuracies) {
    ...
    if (!ctx) {
        console.warn('Canvas perRecordChart не найден');
        return;
    }
...
function initTop5Chart(data) {
    ...
    if (!ctx) {
        console.warn('Canvas top5Chart не найден');
        return;
    }
...
function destroyCharts() {
    ...
    console.log('Графики уничтожены');
}
